...
function getCurrentClasstime() {
  ...
  const timeSlots = [
  { slot: '1', start: '09:20', end: '11:00' },
  { slot: '2', start: '11:10', end: '12:50' },
  { slot: '3', start: '13:40', end: '15:20' },
  { slot: '4', start: '15:30', end: '17:10' },
  { slot: '5', start: '17:20', end: '23:00' }
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const classtime = '1';  //getCurrentClasstime()  試験的に1限で固定
  ...
  try {
    const response = await fetch('/api/login', {
      ...
      body: JSON.stringify({ studentId, password, classtime })  // password変数を使う
    });
