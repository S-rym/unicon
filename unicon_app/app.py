    ...
    try:
        ...
        try:
            ...
            if (isinstance(reservation_data, dict)
                and "reserved" in reservation_data
                and "available" in reservation_data):
                reserved_entries = reservation_data.get("reserved", {})
                all_reserved = []
                for slot_entries in reserved_entries.values():
                    all_reserved.extend(slot_entries)
                available_entries = reservation_data.get("available", {})
